...
module.exports = {
    ...
    contractSizer: {
        ...
        except: ["@openzeppelin/contracts/", "tests/"],
    },
    ...
    gasReporter: {
        ...
        excludeContracts: ["@openzeppelin/contracts/", "tests/"],
    },
    ...
    abiExporter: {
        ...
        flat: true,
        spacing: 2,
        except: ["@openzeppelin/contracts/", "interface/", "tests/"],
    },
    ...
    docgen: {
        pages: "items",
        exclude: ["@openzeppelin/contracts/", "interface/", "tests/"],
    },
